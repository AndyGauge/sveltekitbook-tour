...
const raw = [
  {
    title: 'Why a book',
    hook: 'Most LLM output is a wall. A book is a shape.',
    body: 'A model can answer almost anything, but the answer arrives flat — paragraph after paragraph with no architecture, no edges, no place for a reader to stand. [[sveltekitbook]] is a wager that the failure is not in the model, it is in the container. Give the same content one topic per page, with a [[hook]], a body, and a plain-terms aside, and a reader can hold it. The container is the argument.',
  ...
  },
  {
    ...
    hook: 'A worked example: take real policy, lay it on a spectrum, let the reader find themselves.',
  ...
  {
    title: 'The wager',
    hook: 'Walk an agent through what a book needs and the output comes back human-shaped.',
  ...
  {
    title: 'The outline',
    hook: 'One file. One source of truth. Page numbers fall out of order.',
  ...
  {
    title: 'The continuum',
    hook: 'Three formats: none, timeline, spectrum. Pick the axis the book lives on.',
  ...
  {
    title: 'Rooms',
    hook: 'A book is more than its pages. The other rooms make the pages legible.',
  ...
  {
    title: 'The runtime',
    hook: 'Small on purpose: gestures, md, palette, Giscus. Everything else is yours.',
  ...
  {
    title: 'Cross-links',
    hook: 'Write `[[term]]` anywhere in a body. It auto-links to the glossary.',
    body: 'In any field rendered through `md()` — `body`, `hook`, `eli5` — wrap a term in double square brackets and it becomes a link to that entry in the glossary. The match is case-insensitive against the glossary keys. The glossary itself is a single object in `src/lib/glossary.js`. Cross-references between glossary entries are supported via a `see` array. There is no separate authoring step; you just write `[[hook]]` and it links.',
  ...
  {
    title: 'Gestures',
    hook: 'Wheel right, swipe left, press →. The same intent, three input devices.',
  ...
  },
  {
    ...
    hook: 'It is a SvelteKit site with adapter-static. `npm run build`, drop the folder, done.',
  ...
  {
    title: 'Edit freely',
    hook: 'The scaffold is a starting point, not a contract. Routes are yours.',
